...
SWEP.NoPenetration = {[MAT_SLOSH] = true, [MAT_SAND] = true, [MAT_DIRT] = true, [MAT_METAL] = true, [MAT_TILE] = true, [MAT_WOOD] = true, [MAT_GLASS] = true, [MAT_CONCRETE] = true}
...
SWEP.PenetrationMaterialInteraction = {[MAT_SAND] = 0.5, [MAT_DIRT] = 0.8, [MAT_METAL] = 1.1, [MAT_TILE] = 0.9,}
local bul, tr = {}, {}
