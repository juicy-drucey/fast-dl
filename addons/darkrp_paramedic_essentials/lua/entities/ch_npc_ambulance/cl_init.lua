...
local mat_overhead_icon = Material( "materials/craphead_scripts/medic_ui/ambulance.png", "noclamp smooth" )
...
function ENT:DrawTranslucent()
	...
	cam.Start3D2D( self:GetPos() + self:GetUp() * 85, Angle( 0, AngEyes.y - 90, 90 ), 0.05 )
		...
		draw.SimpleTextOutlined( CH_AdvMedic.LangString( "Ambulance NPC" ), "MEDIC_NPC_Overhead", -90, 60, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 2, color_black )
		...
		draw.SimpleTextOutlined( CH_AdvMedic.LangString( "Retrieve an ambulance here!" ), "MEDIC_NPC_OverheadSmaller", -90, 180, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 2, color_black )
	cam.End3D2D()
end