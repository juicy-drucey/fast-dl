...
function zgo2.Seed.DrawTexture(w, h, PlantData,ImgurMat)
	...
	if PlantData.style.seedbox.title_enabled then
		draw.SimpleText(PlantData.name, zclib.GetFont("zclib_world_font_medium"), w * PlantData.style.seedbox.title_pos_x, h * PlantData.style.seedbox.title_pos_y, PlantData.style.seedbox.title_color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end
