...
zgo2.util.ClassList["zgo2_palette"] = true
zgo2.util.ClassList["zgo2_edible"] = true
zgo2.util.ClassList["zgo2_backmix"] = true
zgo2.util.ClassList["zgo2_oven"] = true
zgo2.util.ClassList["zgo2_mixer"] = true
zgo2.util.ClassList["zgo2_mixerbowl"] = true

zgo2.util.ClassList["zgo2_seedlibary"] = true

function zgo2.Print(msg)
	MsgC(Color(95, 194, 56), "[Zero´s GrowOP 2] -> ", Color(255, 255, 255), msg .. "\n")
end
...
function zgo2.util.ConvertJobIDToCommand(data)
	...
	if not RPExtraTeams then return data end
...
function zgo2.util.ConvertJobCommandToJobID(data)
	...
	if not DarkRP then return data end
	// Is the data a single item or a list of items?
	if data.jobs then
