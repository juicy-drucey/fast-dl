...
function zgo2.Plant.GetID(ListID)
	if zgo2.config.Plants_ListID[ListID] then return ListID end
...
function zgo2.Plant.GetListID(UniqueID)
	if zgo2.config.Plants[UniqueID] then return UniqueID end
...
function zgo2.Plant.RandomizeStyleData(Data)
	...
	zgo2.Plant.RandomizeColorData(Data)

	return Data
end

function zgo2.Plant.RandomizeColorData(Data)
