...
hook.Add( "PlayerSwitchWeapon", "bshields_on_weapon_change", function(ply)
	bshield_remove(ply)
end)
...
hook.Add( "PlayerDisconnected", "bshields_remove_dshields_dc", function(ply) 
	RemoveDeployedShields(ply) 
end)
hook.Add( "PlayerDeath", "bshields_remove_dshields_d", function(ply)
	if(!bshields.config.removeondeath) then return end
	RemoveDeployedShields(ply)
end)
