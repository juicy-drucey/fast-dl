...
function PANEL:Init( )
    ...
    */
    ...
    :clr                            ( self.cf_d.clrs.header_txt             )
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        draw.SimpleText( self:GetLabel( ), pref( 'cwserv_hdr_name' ), 25, h / 2, self.cf_d.clrs.header_txt, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )
                                    end )
    ...
    */
    ...
    :fill                           ( 'm', 4, 0, 4, 0                       )
    :tall                           ( 20                                    )
    :rbox                           ( cfg.dialogs.clrs.errors_box, 4        )
    ...
    */
    ...
    :notext                         (                                       )
    :fill                           ( 'm', 3, 3, 0, 3                       )
    :txt                            ( lang( 'cwserv_setup_servers' ), cfg.dialogs.clrs.errors_txt, pref( 'cwserv_err' ), false, 5 )
    ...
    */
    ...
    :tall                           ( 32                                    )
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        draw.SimpleText( helper.get:utf8( 'dtxt' ), pref( 'cwserv_info_icon' ), 4, 15, self.cf_d.clrs.icon_bullet, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER )
                                    end )
    ...
    */
    ...
    local dt_default                = lang( 'cwserv_inv_ipport' )
    ...
    */
    ...
    :notext                         (                                       )
    :wide                           ( 28                                    )
    :tip                            ( lang( 'tt_cwserv_copy_ipport' )       )
    ...
    */
    ...
    :notext                         (                                       )
    :wide                           ( 28                                    )
    :tip                            ( lang( 'tt_cwserv_confirm_yes' )       )
...
function PANEL:Paint( w, h )
    ...
    */
    ...
    if limit == 1 and #self.clipb_data == 0 then
        timex.simple( 'arivia_cl_copy_anim', 0.1, function( )
...
function PANEL:GetLabel( )
    return ( isstring( self.label ) and self.label ~= '' and self.label ) or lang( 'cwserv_connect_to_server', self.server_name )
end
...
function PANEL:SetServerName( str )
    ...
    self.dt_desc:SetText( lang( 'cwserv_connect_confirm', str ) )
end
...
function PANEL:_Declare( )
    ...
    */
    ...
    self._anim_scrtxt               = design.anim_scrolltext( lang( 'cwserv_copy_clipb' ), call( 'hooks', 'arivia_ol_copy_clipb' ), self.clipb_data, pref( 'cwserv_copyclip' ), Color( 255, 255, 255, 255 ), 0.5, 2 )
