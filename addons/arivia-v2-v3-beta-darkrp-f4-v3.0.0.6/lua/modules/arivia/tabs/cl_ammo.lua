...
function PANEL:_Lang( )
    self.l_ent_amt_name     = ln( 'mem_ammo_name' )
    ...
    for cat in helper.get.data( cats ) do
        ...
        */
        ...
        for v in helper.get.data( cat.members ) do
            local bCanBuy, bShow    = mod.ammo:bCanBuy( v )
        ...
        */
        ...
        for v in helper.get.data( cat.members ) do
            ...
            */
            ...
            local ent_ammo                              = v.amountGiven or 0
            local ent_price                             = handle:GetCost( price )
            local ent_max                               = v.max and v.max > 0 and v.max or ln( 'handle_unlim_i' )
            ...
            */
            ...
            :setupanim              ( 'OnHoverFade', 4, rlib.i.OnHover      )
                                    ...
                                    */
                                    ...
                                    :omc( function( s )
                                        if handle:GetAccessSAdmin( 'arivia_sa_tools' ) then
                                            local name          = v.ammoType or v.type or ''
            ...
            */
            ...
            local mdl_src           = istable( v.model ) and v.model[ 1 ] or v.model
            local mdl_fov           = ( cfg.models.slot.man[ mdl_src ] and cfg.models.slot.man[ mdl_src ].fov ) or 70
            ...
            local mdl_oset          = ( cfg.models.slot.man[ mdl_src ] and cfg.models.slot.man[ mdl_src ].oset ) or Vector( 0, 2, 0 )
...
function PANEL:Populate( v )
    ...
    */
    ...
    local m_sel_fov                 = ( cfg.models.sel.man[ m_sel_src ] and cfg.models.sel.man[ m_sel_src ].fov ) or 111
...
function PANEL:GetDesc( item )
    ...
    if item.amountGiven then
        local str                   = ln( 'sel_desc_ammo_amt', item.amountGiven )
        desc                        = desc .. str .. '\n\n'
    end
...
function PANEL:GetAction( item )
    ...
    rcc.run.gmod( 'darkrp', 'buyammo', item.ammoType )
end
...
ui:create( mod, 'pnl_tab_ammo', PANEL, 'pnl' )