    ...
    for cat in helper.get.data( cats ) do
        ...
        */
        ...
        for v in helper.get.data( cat.members ) do
            local bCanBuy, bShow    = mod.weps:bCanBuy( v )
        ...
        */
        ...
        for v in helper.get.data( cat.members ) do
            ...
            */
            ...
            local ent_amount                            = v.amount or 0
                                    ...
                                    */
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        */
                                        ...
                                        draw.DrawText( cir_l1, pref( 'slot_item_cir_val1' ), cir_w, ( self.cir_pos_h - 5 ) or 20, clrs.list.btn_lvl_1, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
...
function PANEL:GetAction( item )
    ...
    rcc.run.gmod( 'darkrp', 'buy', item.name )
end
...
function PANEL:Think( )
    if mod.weps.i == 0 and not ui:visible( '$tab_store_nores', mod ) then
        self.scr:Hide( )
        self.sel:Hide( )
        self:NoResults( )
    end
    ...
    */
    ...
    :tall                           ( 36                                    )
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        draw.SimpleText( ln( 'lst_results_weps_none' ), pref( 'slot_results_none_msg' ), w / 2, h / 2 + 35, Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
                                    end )
...
ui:create( mod, 'pnl_tab_weps', PANEL, 'pnl' )