...
function PANEL:_Lang( )
    self.l_ent_amt_name     = ln( 'mem_max_name' )
    ...
    for cat in helper.get.data( cats ) do
        ...
        */
        ...
        for v in helper.get.data( cat.members ) do
            local bCanBuy, bShow    = mod.ents:bCanBuy( v )
        ...
        */
        ...
        for v in helper.get.data( cat.members ) do
            ...
            */
            ...
            local ent_max                               = ( v.getMax and v.getMax( LocalPlayer( ) ) ) or v.max or 0
...
function PANEL:Populate( v )
    ...
    */
    ...
    local m_sel_fov                 = ( cfg.models.sel.man[ m_sel_src ] and cfg.models.sel.man[ m_sel_src ].fov ) or 120
...
ui:create( mod, 'pnl_tab_ents', PANEL, 'pnl' )