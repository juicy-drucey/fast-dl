    ...
    for cat in helper.get.data( cats ) do
        ...
        */
        ...
        for v in helper.get.data( cat.members ) do
            local bCanBuy, bShow    = mod.vehc:bCanBuy( v )
        ...
        */
        ...
        for v in helper.get.data( cat.members ) do
            ...
            */
            ...
            local ent_special                           = handle:GetVehicleSpec( v )
            ...
            :setupanim              ( 'OnHoverFade', 4, rlib.i.OnHover      )
                                    ...
                                    */
                                    ...
                                    :logic( function( s )
                                        ...
                                        s.amt               = ent_special
                                        s.cir_l1_n          = ( self.bLevelEnabled and ent_level and self.l_ent_lvl_name ) or cfg.ent.vehicles[ 'name' ]
                                        s.cir_l2_n          = ( self.bLevelEnabled and ent_level ) or s.amt

                                        s.cir_l1_h          = cfg.ent.vehicles[ 'name' ]
                                        s.cir_l2_h          = s.amt
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        */
                                        ...
                                        /*
                                        *	draw > info > custom value
                                        */

                                        if cfg.ent.vehicles.bCustomValEnabled then
            ...
            */
            ...
            local mdl_src           = istable( v.model ) and v.model[ 1 ] or v.model
            local mdl_fov           = ( cfg.models.slot.man[ mdl_src ] and cfg.models.slot.man[ mdl_src ].fov ) or 35
            ...
            local mdl_oset          = ( cfg.models.slot.man[ mdl_src ] and cfg.models.slot.man[ mdl_src ].oset ) or Vector( 0, 30, 0 )
...
function PANEL:Populate( v )
    ...
    */
    ...
    local m_sel_fov                 = ( cfg.models.sel.man[ m_sel_src ] and cfg.models.sel.man[ m_sel_src ].fov ) or 55
    ...
    local mdl_oset                  = ( cfg.models.sel.man[ m_sel_src ] and cfg.models.sel.man[ m_sel_src ].oset ) or Vector( 0, 0, -5 )
...
function PANEL:GetAction( item )
    ...
    rcc.run.gmod( 'darkrp', 'buyvehicle', item.name )
end
...
ui:create( mod, 'pnl_tab_vehc', PANEL, 'pnl' )